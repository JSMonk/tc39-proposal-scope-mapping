...
test("original frames at line 4", () => {
    ...
    expect((0, getOriginalFrames_1.getOriginalFrames)({ line: 3, column: 4 }, { sourceIndex: 0, line: 3, column: 4 }, generatedScopes, originalScopes, debuggerScopes)).toMatchInlineSnapshot(`
[
  {
    "location": {
      "column": 4,
