...
test("original scopes at line 2", () => {
    ...
    expect((0, getOriginalFrames_1.getOriginalFrames)({ line: 1, column: 0 }, { sourceIndex: 0, line: 5, column: 2 }, generatedScopes, originalScopes, debuggerScopes)).toMatchInlineSnapshot(`
[
  {
    "location": {
      "column": 2,
